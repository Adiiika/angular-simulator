...
export class ThemeService {
  ...
  private themeState: BehaviorSubject<ITheme | null> = new BehaviorSubject<ITheme | null>(
    this.getSavedTheme(),
  );
  ...
  changeTheme(theme: Theme): void {
    const currentTheme: ITheme | undefined = this.themes.find(
      (preset: ITheme) => preset.theme === theme,
    );
